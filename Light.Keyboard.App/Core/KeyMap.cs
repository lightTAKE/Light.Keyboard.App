    ...
    public class KeyMap : IKeyMap
    {
        ...
        public KeyMap()
        {
            Keys = new List<Key>
            {
                ...
                new Key(KeyNames.ARROW_UP, 12, 4),
                new Key(KeyNames.NUM_ONE, 13, 4),
                new Key(KeyNames.NUM_TWO, 14, 4),
                new Key(KeyNames.NUM_THREE, 15, 4),
                new Key(KeyNames.NUM_ENTER, 16, 4),

                new Key(KeyNames.LEFT_CONTROL, 0, 5),
                new Key(KeyNames.LEFT_WINDOWS, 1, 5),
                new Key(KeyNames.LEFT_ALT, 2, 5),
                new Key(KeyNames.SPACE, 3, 5),
                new Key(KeyNames.RIGHT_ALT, 4, 5),
                new Key(KeyNames.RIGHT_WINDOWS, 5, 5),
                new Key(KeyNames.APPLICATION_SELECT, 6, 5),
                new Key(KeyNames.RIGHT_CONTROL, 7, 5),
                new Key(KeyNames.ARROW_LEFT, 8, 5),
                new Key(KeyNames.ARROW_DOWN, 9, 5),
                new Key(KeyNames.ARROW_RIGHT, 10, 5),
                new Key(KeyNames.NUM_ZERO, 11, 5),
                new Key(KeyNames.NUM_PERIOD, 12, 5)
            };
        }
